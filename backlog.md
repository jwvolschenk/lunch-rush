...
- [ ] Dishwasher tower — referenced in CardPool.gd line 77 but no Dishwasher.tscn scene exists. Implement as fast melee tower (range=80, dmg=12, cooldown=0.8s), high risk/reward short-range attacker.
